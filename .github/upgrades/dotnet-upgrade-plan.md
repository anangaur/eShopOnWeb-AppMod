...
| System.IdentityModel.Tokens.Jwt | 6.23.0 | 8.10.0 | Security vulnerability, deprecated, move to latest |
| System.Net.Http.Json | 6.0.0 | 9.0.5 | Recommended for .NET 9.0 |
| System.Text.Json | 6.0.5 | 9.0.5 | Security vulnerability, recommended for .NET 9.0 |
| Microsoft.VisualStudio.Azure.Containers.Tools.Targets | 1.17.0 | null | Incompatible with .NET 9.0 |
| Microsoft.AspNetCore.Mvc | 2.2.0 | 2.3.0 | Deprecated, move to latest |
...
NuGet packages changes:
  - System.Text.Json should be updated from `6.0.5` to `9.0.5` (*security vulnerability, recommended for .NET 9.0*)
  - System.Security.Claims should be removed (functionality included with new framework reference)
...
Project properties changes:
  - Target framework should be changed from `net6.0` to `net9.0`
NuGet packages changes:
  - Microsoft.AspNetCore.Identity.EntityFrameworkCore should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.EntityFrameworkCore.InMemory should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.EntityFrameworkCore.SqlServer should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - System.IdentityModel.Tokens.Jwt should be updated from `6.23.0` to `8.10.0` (*security vulnerability, deprecated, move to latest*)
...
Project properties changes:
  - Target framework should be changed from `net6.0` to `net9.0`
NuGet packages changes:
  - Microsoft.AspNetCore.Components.Authorization should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Components.WebAssembly should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Components.WebAssembly.Authentication should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Components.WebAssembly.DevServer should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.Extensions.Identity.Core should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.Extensions.Logging.Configuration should be updated from `6.0.0` to `9.0.5` (*recommended for .NET 9.0*)
  - System.Net.Http.Json should be updated from `6.0.0` to `9.0.5` (*recommended for .NET 9.0*)
...
Project properties changes:
  - Target framework should be changed from `net6.0` to `net9.0`
NuGet packages changes:
  - Microsoft.AspNetCore.Components.WebAssembly.Server should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.EntityFrameworkCore.InMemory should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.VisualStudio.Web.CodeGeneration.Design should be updated from `6.0.8` to `9.0.0` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Diagnostics.EntityFrameworkCore should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Identity.EntityFrameworkCore should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Identity.UI should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.EntityFrameworkCore.SqlServer should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.AspNetCore.Authentication.JwtBearer should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - Microsoft.EntityFrameworkCore.Tools should be updated from `6.0.8` to `9.0.5` (*recommended for .NET 9.0*)
  - System.IdentityModel.Tokens.Jwt should be updated from `6.23.0` to `8.10.0` (*security vulnerability, deprecated, move to latest*)
...
Project properties changes:
  - Target framework should be changed from `net6.0` to `net9.0`
NuGet packages changes:
  - Microsoft.AspNetCore.Mvc should be updated from `2.2.0` to `2.3.0` (*deprecated, move to latest*)
